...
[ExecuteInEditMode]
public class UnfoldUV : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        m_cmd.DrawMesh(mesh, render.transform.localToWorldMatrix, material);
        
        // material.SetTexture("_TestTex", texture);
        // m_cmd.Blit(null, rtID, material);
        // m_cmd.DrawRenderer(render, material);
